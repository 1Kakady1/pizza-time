...
export const Order = ({cart, sendOrder, goHome, onClear}: IOrderProps) => {
    ...
    const initValue:IOrderForm = {
        email: '', name: '', address: "", comments: '', date: new Date()
    }
    ...
    const getDate  = (datetime: Date) =>{
        ...
        return `${date.day < 10 ? 0 :""}${date.day}.${date.month+1 < 10? 0 :""}${date.month+1} ${date.hours < 10 ? 0 :""}${date.hours}:${date.min < 10 ? 0 :""}${date.min}`;
    }
