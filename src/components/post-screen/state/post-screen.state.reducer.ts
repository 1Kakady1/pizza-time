...
const setPostParam = (state:IPost, { payload }: { payload: {id: string, size: string} })=>{
  state.post = undefined;
  state.id = payload.id;
  state.size = payload.size;
}

const postRequest = (state:IPost, { payload }: { payload: {id: string, size: string} })=>{
  return{
    ...state,
    isLoad: true,
    post: undefined,
...
const postRequestSuccess = (state:IPost, { payload }: { payload: IPostItem })=>{
  return {
    ...state,
    post: payload,
    isLoad: false,
...
const postRefreshRequestSuccess = (state:IPost, { payload }: { payload: IPostItem })=>{
  return {
    ...state,
    post: payload,
    isRefresh: false,
...
const postRefreshRequestFailed = (state:IPost, { payload }: { payload: string })=>{
