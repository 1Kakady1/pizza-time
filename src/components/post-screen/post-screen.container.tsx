...
export const PostItemContainer =  () =>{
    ...
    const cartProductsItem = useSelector(toCartSelector.getCartProduct(route.params.id)) || 0;
    ...
    useEffect(()=>{
        dispatch(toPostAction.clearProduct());
        dispatch(toPostAction.postRequest({id: route.params.id, size: post?.filters.size[0] || "" }))
    },[route.params])
