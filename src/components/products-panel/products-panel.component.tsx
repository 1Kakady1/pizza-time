...
export const ProductsPanel = ({drawerOpen, onOpenSearch, preview}:IProductsPanelProps) => {
  const [t] = useTranslation();
  const styles= stylesPrductsPanel;
  return (
    <View style={styles.container}>
        <ImageBackground  source={ preview !== "" ? {uri: preview} : require("./resources/empty.jpg")} style={styles.image}>
