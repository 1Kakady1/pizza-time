...
export const CartContainer = () => {
  ...
  const onAdd = (item: ICartItem, size: string) => dispatch(toCartAction.add({prod: item, size}));
  const onSub = (item: ICartItem, size: string) => dispatch(toCartAction.sub({prod: item, size}));
  ...
  const onRemove = (value: {id:string, size: string}) =>  dispatch(toCartAction.remove(value))
  const onChangeComments = (value: ICartComments) =>  dispatch(toCartAction.changeComments(value))
