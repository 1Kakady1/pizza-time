...
export const HeaderContainer =  ({back,title,icon,showSettings}: IHeaderContainerProps) =>{

    const navigation = useNavigation();
    const dispatch = useDispatch();
    const onOpenSetting = showSettings ? ()=>  dispatch(toHeaderAction.onOpenSetting()) : undefined
    const onHeaderLeft = ()=>{
